...
add
    ...
    document.getElementById("body").before(navAddMenu);
    ...
    updateIconList("");
    (_a = document
        .getElementById("iconSearch")) === null || _a === void 0 ? void 0 : _a.addEventListener("input", function () {
        const query = input.value.toLowerCase();
        updateIconList(query);
    });
    function updateIconList(query) {
        results.innerHTML = "";
        icons
