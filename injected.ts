...
add
    ...
    let navAddMenu = document.createElement("div");
    navAddMenu.className = "navAddMenu";
    navAddMenu.innerHTML =
        "<h2 style=`display:block`>Add Settings to Nav Bar</h2>";
    (document.getElementById("body") as HTMLDivElement).before(navAddMenu);
    let navAddChoices = document.createElement("ul");
    navAddChoices.className = "navAddChoices";
    navAddMenu.appendChild(navAddChoices);

    let choice1 = document.createElement("li");
    choice1.className = "navChoice";
    choice1.innerHTML = `<span class="material-symbols-outlined">add</span> Gunn.one (Grade View)`;
    navAddChoices.appendChild(choice1);

    let choice2 = document.createElement("li");
    choice2.className = "navChoice";
    choice2.innerHTML = `<span class="material-symbols-outlined">add</span>  MobileServe`;
    navAddChoices.appendChild(choice2);

    let choice3 = document.createElement("li");
    choice3.className = "navChoice";
    choice3.innerHTML = `<span class="material-symbols-outlined">add</span>  Learnify (Study Timer)`;
    navAddChoices.appendChild(choice3);

    let navSettingsList = document.createElement("ul");
    navSettingsList.className = "navSettingsList";
    navAddMenu.appendChild(navSettingsList);

    let iconMenu = document.createElement("div");
    iconMenu.className = "iconMenu";
    navSettingsList.appendChild(iconMenu);

    iconMenu.innerHTML =
        "<input id='iconSearch' placeholder='Search Icon'><p id='results'>hi</p>";

    let inputMenu = document.createElement("div");
    inputMenu.className = "inputMenu";
    navSettingsList.appendChild(inputMenu);

    let inputLink = document.createElement("input");
    inputLink.className = "inputLink";
    inputLink.placeholder = "Insert Link Here";
    inputMenu.appendChild(inputLink);

    let saveButton = document.createElement("button");
    saveButton.innerText = "Save";
    saveButton.className = "saveButton";
    inputMenu.appendChild(saveButton);

    const input = document.getElementById("iconSearch") as HTMLInputElement;
    ...
    document
        ...
        ?.addEventListener("input", function () {
            const query = input.value.toLowerCase();
            updateIconList(query);
        });
    function updateIconList(query: string) {
        results.innerHTML = "";
        ...
        icons
            ...
            .forEach((icon) => {
                ...
                el.textContent = icon; // Material icon name
                el.title = icon;
                el.onclick = () => alert("You picked: " + icon);
                setTimeout(() => {
            ...
            asignmentIframe.onload = () => {
                if (asignmentIframe.contentDocument) {
                    if (!asignmentURL.href.includes("launch")) {
                        ...
                        if (grade !== undefined && grade.innerText != null) {
